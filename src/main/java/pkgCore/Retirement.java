...
public class Retirement {
	...
	public double MonthlySavings() {
		...
		pmt = Retirement.PMT(dAnnualReturnWorking / 12, iYearsToWork * 12, 0, this.TotalAmountToSave(), false);
	...
	public double TotalAmountToSave() {
		...
		double pv = 0;
		pv = Retirement.PV(dAnnualReturnRetired / 12, iYearsRetired * 12, dRequiredIncome - dMonthlySSI, 0, false);
